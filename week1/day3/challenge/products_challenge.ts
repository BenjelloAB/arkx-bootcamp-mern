...
// console.log(product);
let preOrder_product: string = product.preOrder;
if (preOrder_product == "true") {
  console.log("On the way");
}

let shipping: number = 0, taxPercent: number = 0.05, taxTotal: number = 0, total: number = 0;

let shippingAddress: string = "Chicago, saint polis N123, DownTown";
